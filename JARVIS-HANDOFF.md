...
3. Reply thoughtfully to unanswered user messages, using conversation context. Do not substitute an automatic receipt for an answer. Choose a UUID for each new publication and preserve that UUID/body when retrying an uncertain write.
