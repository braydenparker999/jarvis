// Adapted from Metaphysics0/songsterr-downloader (MIT); see licenses and guitar/README.md.
...
export class SongsterrToAlphaTabConverter {
  buildScore({ meta, revisions }: SongsterrToGpInput): BuildScoreResult {
  ...
  private mapNote(
    ...
    if (isPercussion) {
      // Direct alphaTab rendering uses MIDI IDs, not GP7 articulation indexes.
