...
$('connect-responder').onclick = async () => {
  ...
  try {
    ...
    $('responder-info').textContent='This code grants inbox reading and replies for 30 days. Enter it only in the responder connection form, never in a chat or public repository. Connecting again replaces the previous connection.';
